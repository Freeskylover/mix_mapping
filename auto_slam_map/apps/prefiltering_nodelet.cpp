...
public:
  ...
  virtual void onInit() {
    ...
    map_build_state_sub = nh.subscribe("map_build_state",5,&PrefilteringNodelet::map_build_stateCallback, this);
...
private:
  ...
  void map_build_stateCallback(const std_msgs::Bool::ConstPtr &msg){
    is_map_building = msg->data;
  }
...
private:
  ...
  ros::Subscriber map_build_state_sub;
  ...
  bool is_map_building = false;//默认开启后暂不进行建图工作
